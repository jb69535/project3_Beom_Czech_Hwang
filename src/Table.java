...
public class Table
    ...
    /**
     * Constructs a new {@code Table} instance with specified attributes, domain,
     * keys, and indexing strategy.
     * This constructor initializes the table with the given name, attributes,
     * domain types, keys, and chooses
     * an indexing structure based on the {@code indexType} parameter. It supports
     * linear hashing via "LinHashMap"
     * or a default tree map for indexing.
     *
     * @param _name      The name of the table.
     * @param _attribute An array of strings representing the names of the
     *                   attributes/columns of the table.
     * @param _domain    An array of {@code Class} objects representing the data
     *                   types of each attribute/column.
     *                   Each position in the array corresponds to the attribute at
     *                   the same position in the
     *                   {@code _attribute} array.
     * @param _key       An array of strings representing the names of the
     *                   attributes that form the primary key.
     *                   Each string in the array should match an entry in
     *                   {@code _attribute}.
     * @param indexType  A string indicating the type of indexing to use. Currently
     *                   supports "LinHashMap" for
     *                   linear hashing map implementation, or any other value
     *                   defaults to using {@code TreeMap}.
     *                   It influences how data is indexed and retrieved from the
     *                   table.
     */
    ...
    public Table join(String attributes1, String attributes2, Table table2) {
        ...
        Table result = new Table(name + count++, newAttributes.toArray(new String[0]), newDomains.toArray(new Class[0]),
                key);
